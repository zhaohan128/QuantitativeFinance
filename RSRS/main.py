# -*- coding: utf-8 -*-
#光大证券--金融工程--20170501--基于阻力支撑相对强度（RSRS）的市场择时——技术择时系列报告之一
#代码出处：https://blog.csdn.net/weixin_43915798/article/details/116097715?spm=1001.2014.3001.5502
#相关研报：见文件夹
#本文件：主要对基于阻力支撑相对强度（RSRS）择时进行回测，需要数据包含，最低价'low'，最高价'high'，收盘价'close'
#测试时间：20220308
